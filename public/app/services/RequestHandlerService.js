...
app.factory('RequestHandler', ['$http', '$q', '$log', '$rootScope', '$location', function ($http, $q, $log, $rootScope, $location) {

    $rootScope.transaction = {};

    //Recuperation des differentes configs
    var getConfig = function(myConfig){
    ...
    return {
        ...
        get: function (url, myConfig) {
            myConfig = (myConfig === undefined ? "apiTeurpi" : myConfig);
            var promise = $q.defer();
            $http.get(url, getConfig(myConfig)).
